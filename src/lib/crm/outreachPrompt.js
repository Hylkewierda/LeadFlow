// Pure prompt builder for CRM outreach generation. No network / no React, so it's
// unit-testable in isolation and importable by the server route. Design:
// docs/superpowers/specs/2026-06-24-crm-outreach-from-context-design.md.
