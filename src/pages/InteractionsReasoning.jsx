...
const SHEETS = [
  {
    ...
    info: "Overzicht van iedereen die met je posts heeft geïnterageerd — likes, comments en shares. Dit is de bron voor de profielen die de Account- en Comment-workflows verzamelen.",
  },
  {
    ...
    info: "De leaddata uit je actieve LinkedIn-campagnes, zoals verwerkt door de Campaigns-workflow.",
  },
  {
    ...
    info: "De comment-engagement per post — wie heeft er gereageerd en op welke post. Voedt de Comment Posts-workflow.",
  },
  {
    label: "Reasoning",
    ...
    info: "De gedetailleerde uitleg van de AI per lead: waarom een bepaalde score en kwalificatie is toegekend. Handig om te begrijpen hoe het model beslist.",
  },
];
          ...
          {SHEETS.map((sheet, index) => {
            ...
            return (
              ...
              >
                ...
                {sheet.info && <MoreInfo>{sheet.info}</MoreInfo>}
              </motion.div>
            );
          })}
        </div>
